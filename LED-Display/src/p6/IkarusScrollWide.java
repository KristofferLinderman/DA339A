...
public class IkarusScrollWide extends JPanel {
	...
	private class ButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			if (e.getSource() == setText) {
				...
				// \\w represents [a-zA-Z0-9_] \\Q and \\E is quote, which is
				// mechanism to escape metacharacters, even in character class.
				String inputFormat = " \\w\\Q!#()*+,-./<=>?[\\]\\E+{1,50}";
				...
				if (!(input.matches(inputFormat))) {
					JOptionPane.showMessageDialog(null, "Characters not supported", "Input error",
	 ...
	 * 
	 * @author Kristoffer and Pierre Lejdbring
	 *
	 */
	...
	public static void main(String[] args) {
		...
		IkarusScrollWide pusher = new IkarusScrollWide();
		frame.add(pusher);
