...
public class ColorDisplay extends JComponent {
	...
	public static void main(String[] args) {
		 ...
		 {Color.RED,Color.BLUE,Color.BLUE,Color.BLUE,Color.BLUE,Color.BLUE,Color.RED},
		 {Color.RED,Color.BLUE,Color.RED,Color.RED,Color.RED,Color.RED,Color.RED},
		 {Color.RED,Color.BLUE,Color.RED,Color.RED,Color.RED,Color.RED,Color.RED},
		 {Color.RED,Color.BLUE,Color.RED,Color.RED,Color.RED,Color.RED,Color.RED},
		 {Color.RED,Color.BLUE,Color.RED,Color.RED,Color.RED,Color.RED,Color.RED},
		 {Color.RED,Color.RED,Color.RED,Color.RED,Color.RED,Color.RED,Color.RED}};
		 ColorDisplay d = new ColorDisplay(4,2,Color.WHITE,Color.BLACK,1,10);
		 d.setDisplay(arr,1,1); // arr har röd-värde i samtliga element
		 d.updateDisplay();

		JOptionPane.showMessageDialog(null,d);
		//JOptionPane.showMessageDialog(null, new ColorDisplay(1,2,Color.RED,Color.BLACK,2,50));
	}
}
